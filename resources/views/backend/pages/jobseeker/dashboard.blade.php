                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body" id="card-body2">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <label for="">Complete your profile to use article feature</label>
                                </div>
                            </div>
                            @if($count_jd > 0)
                            <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="row mb-4">
                            <div class="col-2">
                                <img style="float: right;border-radius: 50%;" width="40px" height="40px" src="/backend/images/faces/<?= jobseeker() == null ? '' : jobseeker()->profile_picture; ?>" alt="">
                            </div>
                            <div class="col-8">
...
<?php } else {
    echo '<marquee class="bg-info text-dark p-3">Complete your profile to use article feature</marquee>';
} ?>
@endsection