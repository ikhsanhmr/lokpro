                            ...
                            <form class="form form-horizontal" method="POST" action="/jobseeker/job_detail" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('ktp_number') autofocus @enderror  type="number" id="email-id" class="form-control @error('ktp_number') is-invalid @enderror"
                                                name="ktp_number" placeholder="KTP Number" value="{{ old('ktp_number') }}">
                                            @error('ktp_number')
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('place_of_birth') autofocus @enderror type="text" id="contact-info" class="form-control @error('place_of_birth') is-invalid @enderror"
                                                name="place_of_birth" placeholder="Place of birth" value="{{ old('place_of_birth') }}">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('date_of_birth') autofocus @enderror type="date" id="contact-info" class="form-control @error('date_of_birth') is-invalid @enderror"
                                                name="date_of_birth" placeholder="Date of birth" value="{{ old('date_of_birth') }}">
                                            @error('date_of_birth')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('address') autofocus @enderror type="text" id="contact-info" class="form-control @error('address') is-invalid @enderror"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('phone_number') autofocus @enderror type="number" id="contact-info" class="form-control @error('phone_number') is-invalid @enderror"
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input @error('religion') autofocus @enderror type="text" id="contact-info" class="form-control @error('religion') is-invalid @enderror"
                                                name="religion" placeholder="Religion" value="{{ old('religion') }}">
                                            @error('religion')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input  @error('document') autofocus @enderror type="file" id="contact-info" class="form-control @error('document') is-invalid @enderror"
