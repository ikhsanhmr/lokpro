  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        ...
        <div class="container">
          ...
          <section class="py-8">
            ...
            <div class="container">
              <div class="row flex-center">
                <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="{{ asset('frontend/assets/img/illustrations/jobs.png') }}" width="450" alt="" /></div>
                <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-8">
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-5 order-md-1 text-center text-md-end"><img class="img-fluid mb-4" src="{{ asset('frontend/assets/img/illustrations/feature.png') }}" width="450" alt="" /></div>
            <div class="col-md-5 text-center text-md-start">
      ...
      <section class="py-0"><img class="w-100" src="{{ asset('frontend/assets/img/illustrations/come-on-join.png') }}" alt="" />
        <div class="container">
